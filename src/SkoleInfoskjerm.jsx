...
export default function SkoleInfoskjerm() {
  ...
  useEffect(() => {
    ...
    }, draft.carouselIntervalMs || 7000);
    return () => clearInterval(t);
  }, [imageUrls.length, draft.carouselIntervalMs]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-emerald-50 text-slate-900 flex flex-col">
      {/* Toppheader */}
